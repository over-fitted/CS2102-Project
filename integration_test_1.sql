...
BEGIN;
    ...
    CALL book_room(1, 1, '2021-1-1'::DATE, '10:00:00'::TIME, '11:00:00'::TIME, 1);
    CALL book_room(1, 1, '2021-1-1'::DATE, '11:00:00'::TIME, '12:00:00'::TIME, 1);
    ...
    CALL join_meeting(1, 1, '2021-1-1'::DATE, '10:00:00'::TIME, '11:00:00'::TIME, 2);
    CALL join_meeting(1, 1, '2021-1-1'::DATE, '11:00:00'::TIME, '12:00:00'::TIME, 2);
...
/*
TODO:
figure out why first bookroom if use 2021-1-1 got error
